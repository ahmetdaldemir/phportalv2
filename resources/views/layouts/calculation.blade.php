...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/angular-ui-utils/0.1.1/angular-ui-utils.min.js"
            class=""></script>
    <script data-require="angular-ui-bootstrap@0.13.3" data-semver="0.13.3"
...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.components.calculation_aside')
                ...
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        <li class="nav-item lh-1 me-3">
                            <a target="_blank" href="{{route("home")}}">CRM</a>
                        </li>
    ...
    text-align: center;"></i>
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <small
                                                    class="text-muted">{{\Illuminate\Support\Facades\Auth::user()->getRoleNames()}}</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
