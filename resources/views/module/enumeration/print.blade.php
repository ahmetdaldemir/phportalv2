                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-responsive">
                            ...
                            <tbody>
                            @php
                                $data = json_decode($table->getContent(),TRUE);
                            @endphp
                            @foreach($data['dataCol'] as $item)
                            ...
                            <?php
                            $falseseller = [];
                            foreach(json_decode($table->getContent(),TRUE)['dataCol']  as $item)
                            {
                                if($item['seller_id'] == $enumeration->seller_id && $item['type'] == 1)
                                {
                                    $ok[] = $item['seller_id'];
